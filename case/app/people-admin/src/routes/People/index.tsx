...
const PeopleList = () => {
  ...
  const renderHeaderCell = (nestingDepth?: number, group?: IGroup) => {
    const columns: IColumn[] = [
      ...
      { key: 'firstName', name: 'Firstname', fieldName: 'firstName', minWidth: 600, maxWidth: 300 },
      { key: 'lastName', name: 'Lastname', fieldName: 'lastName', minWidth: 300, maxWidth: 300 },
      { key: 'sex', name: 'Sex', fieldName: 'sex', minWidth: 300, maxWidth: 300 },
      { key: 'email', name: 'Email', fieldName: 'email', minWidth: 300, maxWidth: 300 },
      { key: 'phone', name: 'Phone', fieldName: 'phone', minWidth: 300, maxWidth: 300 },
      { key: 'dateOfBirth', name: 'Date of Birth', fieldName: 'dateOfBirth', minWidth: 300, maxWidth: 300 },
      { key: 'jobTitle', name: 'Job Title', fieldName: 'jobTitle', minWidth: 300, maxWidth: 300 },
    ];
